// RheumatoidFactor Page Labels
export const RHEUMATOID_FACTOR_LABELS = {
  BREADCRUMB_HEALTH: "Your Health",
  BREADCRUMB_AUTO_IMMUNITY: "Auto Immunity",
  
  TITLE_DEFAULT: "Rheumatoid Factor (RF)",
  TITLE_BIO_AGE: "Biological Age ",
  BIO_AGE_VALUE: "30.5 Years",
  ...
  SUMMARY_PARAGRAPH_1_PART_1: "Jumping headfirst into using AI, like ",
  SUMMARY_PARAGRAPH_1_SPAN_1: "ChatGPT",
  SUMMARY_PARAGRAPH_1_PART_2: ", without a content strategy can lead to some unfortunate results. One common pitfall I've seen is people opting for quantity over quality - they churn out blogs, but each one feels robotic and soulless, reading just like countless others on the internet.",
