export const INTAKE_LABELS = {
  BRAND_TAGLINE: 'PRECISION WELLNESS · PERSONALIZED TO YOU',
  TITLE: 'Patient Intake Questionnaire',
  SUBTITLE: 'A few questions so we can personalize your lab panel and recommendations. It takes about 5 minutes.',
