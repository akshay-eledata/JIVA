// FollowUpTest Page Labels
export const FOLLOW_UP_TEST_LABELS = {
  TITLE: "Follow-Up Test",
  SUBTITLE: "Tuesday August 26, 2025",
  ...
  ORDERED_BY_NAME: "Shrinivasa Bopana",
  
  TAB_PREPARE: "How to Prepare",
  TAB_BIOMARKERS: "Biomarkers",
  
  PREP_HEADING_DAYS: "Your first lab visit in 2 days",
  PREP_HEADING_MORNING: "Morning of the visit",
  ...
  PREP_ARRIVE_TITLE: "Arrive 10 min Early",
