...
const ENTRIES: { names: string[]; content: BiomarkerContent }[] = [
    ...
    },
    {
        ...
        content: {
            ...
            tips: 'A supporting index, best read with the rest of the CBC.',
        },
    },
    {
        names: ['RDW'],
        content: {
            ...
            highMeans: 'High RDW suggests a mix of cell sizes, often an early sign of iron, B12, or folate deficiency.',
    ...
    },
    {
        ...
        content: {
            ...
            lowMeans: 'Low platelets (thrombocytopenia) can raise bleeding and bruising risk, whether from immune causes, medications, infections, or marrow issues.',
    ...
    },
    {
        ...
        content: {
            ...
            whyItMatters: 'LDL is a primary, causal driver of atherosclerosis, so lowering it lowers heart-attack and stroke risk.',
    ...
    },
    {
        ...
        content: {
            ...
            lowMeans: 'Low HDL, which is common with insulin resistance and inactivity, reduces this protective clean-up.',
    ...
    },
    {
        ...
        content: {
            ...
            highMeans: 'Higher hs-CRP signals more systemic inflammation from infection, obesity, smoking, or metabolic stress. Below 1 is low risk and above 3 is higher.',
    ...
    },
    {
        ...
        content: {
            ...
            tips: 'Genotype is fixed, but its risk is modifiable, so prioritise cardiovascular and brain-healthy habits.',
        },
    },
    ...
    },
    {
        ...
        content: {
            ...
            tips: 'Non-specific, so it is interpreted alongside more targeted tests.',
        },
    },
    {
        names: ['Amylase'],
    ...
    },
    {
        ...
        content: {
            ...
            highMeans: 'A high INR means slower clotting, whether from anticoagulants, vitamin K deficiency, or reduced liver function.',
    ...
    // ─────────────────────────── Thyroid ───────────────────────────
    {
        ...
        content: {
            ...
            highMeans: 'High TSH usually means an underactive thyroid (hypothyroidism), which brings fatigue, weight gain, and cold intolerance.',
            lowMeans: 'Low TSH usually means an overactive thyroid (hyperthyroidism), which brings palpitations, weight loss, and anxiety.',
    ...
    },
    {
        ...
        content: {
            ...
            tips: 'Selenium and adequate nutrition support healthy T4 to T3 conversion.',
        },
    },
    {
    ...
    },
    {
        ...
        content: {
            ...
            highMeans: 'Too much selenium is toxic, so keep supplements modest.',
    ...
    },
    {
        ...
        content: {
            ...
            whyItMatters: 'A single fasting value is limited because GH is pulsatile, so IGF-1 is often more informative.',
